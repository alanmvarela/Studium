...
$pondduck = "Estanque";
$puzzle_description = "El juego Rompecabezas es una introducción rapida a los bloques de Blockly y como combinarlos.";
$maze_description = "El juego Laberinto es una introducción a los bucles y condicionales. Comienza simple, pero cada nivel es mas desafiante que el anterior";
$bird_description = "El juego Pájaro es un vistazo mas profundo a los condicionales. El flujo de control es explorado con condicionales mas complejas en cada nivel";
$turtle_description = "El juego Tortuga es un vistazo mas profundo a los bucles. Se utilizan bucles anidados para pintar imagenes mas complejas en cada nivel.";
$movie_description = "El juego Película es una introduccion a las ecuaciones matematicas. Se utiliza la matematica para animar peliculas con una dificultad creciente en cada nivel.";
...
$BlocklyUrlTitle = "Haga clic aqui para ir al el juego.";
...
$OpenQuestionsAttemptedAre = "La pregunta abierta o el juego de Blockly-Games intentada/o está";
$SendEmailToTeacherWhenStudentEndQuizOnlyIfOpenQuestion = "Enviar un correo al profesor cuando el estudiante termina un ejercicio, solo si ha respondido a una pregunta abierta o se ha intentado un juego de Blockly-Games";
$TempScoreXQuestionsNotCorrectedYet = "Nota temporal: %s pregunta(s) abierta(s) y/o juego(s) de Blockly-Games no corregida/o(s) todavía.";
