...
*/
// Blockly-Games constants - Begin
$BlocklyQuestion = "Blockly Game";
$BlocklySelectedGame = "Blockly-Games selected Game";
$BlocklySelectedLevel = "Selected level for Blockly-Games Game";
$BlocklyQuestionLabel = "Question";
$puzzle = "Puzzle";
$maze = "Maze";
$bird = "Bird";
$turtle = "Turtle";
...
$pondduck = "Pond";
$puzzle_description = "Puzzle is a quick introduction to Blockly's shapes and how the pieces snap together.";
$maze_description = "Maze is an introduction to loops and conditionals. It starts simply, but every level is more challenging than the last.";
$bird_description = "Bird is a deep-dive into conditionals. Control-flow is explored with increasingly complex conditions.";
$turtle_description = "Turtle is a deep-dive into loops. Use nested loops to paint a picture. Then publish your art for the world to see.";
$movie_description = "Movie is an introduction to mathematical equations. Use math to animate a movie. Then publish your movie for the world to watch.";
...
$OpenQuestionsAttemptedAre = "Open question or the Blockly-Games game attempted is";
$SendEmailToTeacherWhenStudentEndQuizOnlyIfOpenQuestion = "Relaxed open: E-mail teacher when a student ends an exercise, only if an open question is answered or a Blockly-Games game attempted";
$TempScoreXQuestionsNotCorrectedYet = "Temporary score: %s open question(s) and/or Blockly-Games game(s) not corrected yet.";
// Blockly-Games constants - End
